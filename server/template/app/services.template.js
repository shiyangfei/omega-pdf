...
app.service('MainService', function ($http) {
    ...
    me.omega3DetailText = '\
        <p>大量的学术研究结果和大群体（数万人以上）人体测试显示Omega-3指数水平<4%时，罹患多种疾病的风险大大升高。这些疾病包括心脏病、中风、癌症、痴呆和抑郁等。相比中等数值以下的人而言，数值达理想水平(>8%)的人比低数值的人更长寿。提高你的Omega-3指数并保持高指标会帮助你减少罹患这些疾病的风险。\
        </p>\
        <br>\
        <p>\
    ...
    me.transFatDetailText = '\
        ...
        <br>\
        <p>\
            反式脂肪酸的血中浓度反映了饮食摄入程度。因此，降低血液中反式脂肪酸浓度的唯一方法就是从食物中摄取更少的反式脂肪酸。大多数反式脂肪酸的食物包括蛋糕、饼干、派、油酥点心、薯条、玉米粉薄烙饼、薄脆饼干、爆米花和人造黄油棒等。要知道你自己血液中的反式脂肪酸数值的方法只有测量。\
        </p>';
});